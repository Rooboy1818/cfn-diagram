      ...
      edges.push({
        ...
        arrows: {
          to: {
            ...
            scaleFactor: 1,
            type: "image",
            src: 'data:image/svg+xml,<svg width="800px" height="800px" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="8" stroke="#000000" stroke-width="2"/></svg>'*/
            enabled: true,
            type: "image",
            imageWidth: 24,
            imageHeight: 24,
            ...
            src: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' style='width:60px;height:60px' viewBox='0 0 60 60'%3E%3Cpath fill='%23000000' d='M3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z' /%3E%3C/svg>",

            //src: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' d='M3 12C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12Z' stroke='#000000' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' /%3E%3C/svg>",
